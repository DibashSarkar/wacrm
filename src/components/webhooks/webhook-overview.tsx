    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-6 backdrop-blur-sm">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-xl font-semibold text-white">Generic Webhooks</h2>
          ...
          <div className="flex items-center gap-2 rounded-full border border-slate-800 bg-slate-950 px-3 py-1.5 self-start sm:self-auto">
            <span className="text-xs text-slate-400 font-medium">Last Updated:</span>
            {loading ? (
              <span className="h-2 w-12 animate-pulse rounded bg-slate-800" />
            ) : isConnected ? (
        ...
        <div className="mt-6 border-t border-slate-800/80 pt-6">
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2">
            <div className="flex items-start gap-3 rounded-lg border border-slate-800 bg-slate-950/40 p-4">
              ...
              <div>
                <h4 className="text-sm font-medium text-white">Send customized template messages</h4>
            ...
            <div className="flex items-start gap-3 rounded-lg border border-slate-800 bg-slate-950/40 p-4">
              ...
              <div>
                <h4 className="text-sm font-medium text-white">Trigger real-time triggers</h4>
                <p className="mt-1 text-xs text-slate-400">
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900/40 p-6">
        ...
        <ol className="mt-4 grid gap-6 md:grid-cols-3">
          <li className="relative flex flex-col gap-2 pl-6 before:absolute before:left-0 before:top-0 before:flex before:h-5 before:w-5 before:items-center before:justify-center before:rounded-full before:bg-slate-800 before:text-[10px] before:font-bold before:text-slate-400 before:content-['1']">
            <h4 className="text-xs font-semibold text-white uppercase tracking-wider">Configure settings</h4>
            <p className="text-xs text-slate-400">
              Provide an integration name, pick your WhatsApp number/channel, and grab your unique webhook URL.
            </p>
          </li>
          <li className="relative flex flex-col gap-2 pl-6 before:absolute before:left-0 before:top-0 before:flex before:h-5 before:w-5 before:items-center before:justify-center before:rounded-full before:bg-slate-800 before:text-[10px] before:font-bold before:text-slate-400 before:content-['2']">
            <h4 className="text-xs font-semibold text-white uppercase tracking-wider">Capture sample payload</h4>
            <p className="text-xs text-slate-400">
              Trigger a test submission from HubSpot or Shopify to your webhook URL. This parses the JSON schema for easy mapping.
            </p>
          </li>
          <li className="relative flex flex-col gap-2 pl-6 before:absolute before:left-0 before:top-0 before:flex before:h-5 before:w-5 before:items-center before:justify-center before:rounded-full before:bg-slate-800 before:text-[10px] before:font-bold before:text-slate-400 before:content-['3']">
            <h4 className="text-xs font-semibold text-white uppercase tracking-wider">Create workflows</h4>
            <p className="text-xs text-slate-400">

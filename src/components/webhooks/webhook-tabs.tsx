  ...
  return (
    <div className="space-y-6">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="border border-slate-800 bg-slate-900/50 p-1">
          <TabsTrigger
            value="overview"
            className="data-active:text-primary text-slate-400 data-active:bg-slate-800 flex items-center gap-1.5 px-4 py-2"
          >
